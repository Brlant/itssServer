...
export class Node {
  ...
  nodeType;
  branchNodes;
  constructor({ id, type, isRow, nodeType, title,  rejectKey, completionCondition, userType}) {
    this.groupId = id;
    this.id = HashCode();
    this.type = type;
    this.title = title;
...
export class RowNode extends Node {
  // data = {};
  constructor({ id, type, isRow, nodeType, title, rejectKey, completionCondition, userType }) {
    super({ id, type, isRow, nodeType, title , rejectKey, completionCondition, userType});
  }
}
