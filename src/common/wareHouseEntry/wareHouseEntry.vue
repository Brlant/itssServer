  ...
  <el-dialog :visible="dialogAddEntry" :title="formTitle" width="80%" @close="handleEntryClose">
    ...
    <template>
      <el-form ref="form" :model="formData" :rules="rules">
        ...
        <el-row :gutter="20">
          <el-col :span="8">
            <el-form-item label="发起人" label-width="80px" prop="applicant" :rules="rules.applicant">
              <el-input v-model="formData.applicant"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="发起部门" label-width="80px" prop="department" :rules="rules.department">
              <el-input v-model="formData.department"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="发起日期" label-width="80px" prop="applicationDate" :rules="rules.applicationDate">
        ...
        <el-row :gutter="20">
          <el-col :span="8">
            <el-form-item label="预算类型" label-width="80px" prop="budgetType" :rules="rules.budgetType">
              <el-input v-model="formData.budgetType"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="16">
            <el-form-item label="申请原由" label-width="80px">
        ...
        <el-row :gutter="20">
          <el-col >
            <el-form-item label="订单明细" required></el-form-item>
          </el-col>
          <el-col >
  ...
  data() {
    return {
      ...
      rules: {
        ...
        applicant: [{required: true, message: '请输入发起人', trigger: 'blur'}],
        department: [{required: true, message: '请输入发起部门', trigger: 'blur'}],
