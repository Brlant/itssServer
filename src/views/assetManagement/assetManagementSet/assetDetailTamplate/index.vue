      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          >修改</el-button>
            ...
            :class="[scope.row.status=='1'?'qiyong':'tingyong']"
          >
...
export default {
  ...
  methods: {
    ...
    /**查看详情页面*/
    goDetail(row){
       const obj = { path: "/assetManagement/assetManagementSet/detail",query:{"id":row.id} };
    ...
    handleAdd() {
      ...
      // this.open = true;
      // this.title = "添加用户信息";
      const obj = { path: "/assetManagement/assetManagementSet/add",query:{"action":'add'} };
      this.$tab.closeOpenPage(obj);
    },
        /** 修改按钮操作 */
    handleAcitce(row) {
    ...
    /** 修改按钮操作 */
    handleUpdate(row) {
      const obj = { path: "/assetManagement/assetManagementSet/edit",query:{"id":row.id} };
      this.$tab.closeOpenPage(obj);
    },
    /** 提交按钮 */
    submitForm() {
