<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="perms" label="权限标识"  width="160" :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="component" label="组件路径"  min-width="160" :show-overflow-tooltip="true"></el-table-column>
