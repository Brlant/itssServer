      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        ...
        <el-row>
          <el-col :span="24">
             ...
             <el-form-item label="区域-职位-级别">
              <el-select v-model="form.postId" filterable   placeholder="请选择区域-职位-级别">
                <el-option
...
<script>
import { listUser, getUser, delUser, addUser, updateUser, resetUserPwd, changeUserStatus ,changeStatus} from "@/api/system/user";
